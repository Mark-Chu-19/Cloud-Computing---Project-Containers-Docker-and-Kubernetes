package com.wecloud.controller;

import com.wecloud.config.ProfileLoadBalanceConfig;
...
public class ProfileController {
    ...
    /**
     * Map to "/getsingleprofile" HTTP requests.
     *
     * @param username parameter
     * @return JSON string (profile result)
     */
    @RequestMapping(value = "/chat/getsingleprofile", produces = "application/json", method = RequestMethod.GET)
    @ResponseBody
     ...
     * @return JSON string (profile result)
     */
    @RequestMapping(value = "/chat/getallprofiles", produces = "application/json", method = RequestMethod.GET)
    @ResponseBody
