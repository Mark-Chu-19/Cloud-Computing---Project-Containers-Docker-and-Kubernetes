...
import com.wecloud.model.ChatMessage;
import com.wecloud.model.ChatMessageRepository;
...
public class MessageController {
     ...
     */
    @RequestMapping(value = "/chat/getallmessages", produces = "application/json", method = RequestMethod.GET)
    @ResponseBody
